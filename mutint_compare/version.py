"""The version of mutint-compare itself.
...
both fall back to the Django app label -- `mutint_compare` -- so this is what makes a
component name itself after its repository, the way mutint-core does.

Bump it with `./mutint version --bump patch --component mutint-compare`, and tag

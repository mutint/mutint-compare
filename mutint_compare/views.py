...
def mutation_table(request):
    ...
    try:
        ...
        # The two row sets, over the same calls the rows are: filtered, ancestor subtracted,
        # AMP included. The matrix annotates and offers; the reader chooses in the browser.
